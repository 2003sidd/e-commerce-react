            ...
            <>
                <div className="bg-gray-100 p-6">
                    ...
                    <div className="p-4 bg-white">
                        <div className="py-4 text-xl bold">Brand</div>
                        ...
                        <div className="flex flex-row  bg-white">
                            ...
                            <div className=" w-1/2 text-end">
                                <button className="py-2 px-6 text-white font-bold border-2 rounded-xl bg-blue-600 "><Link to="/admin/addBrand">Add + </Link></button>
                            </div>
                        </div>

                ...
                <div className="p-4 rounded-2xl bg-white">
                    ...
                    <div className="flex flex-row  bg-white">
                        ...
                        <div className=" w-1/2 text-end">
                            <button className="py-2 px-6 text-white font-medium border-2 rounded-xl" style={{backgroundColor:"var(--primary-color)"}}><Link to="/admin/colorupsert">Add + </Link></button>
                        </div>
                    </div>
